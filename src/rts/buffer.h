...
extern procedure core.internal.buffer.serializeBoxedObject(owned) -> (uint, pointer);
extern procedure core.internal.buffer.deserializeBoxedObject(uint32, pointer) -> owned;
