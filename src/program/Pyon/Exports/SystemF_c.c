...
#define ADD_OBJECT(name, factory) \
  ...
  ADD_OBJECT("con_AdditiveDict", pyon_con_AdditiveDict);
  ADD_OBJECT("con_VectorDict", pyon_con_VectorDict);
  ...
  ADD_OBJECT("con_ZERO_Int", pyon_con_ZERO_Int);
  ADD_OBJECT("con_ADD_Int", pyon_con_ADD_Int);
  ADD_OBJECT("con_SUB_Int", pyon_con_SUB_Int);
  ADD_OBJECT("con_ZERO_Float", pyon_con_ZERO_Float);
  ADD_OBJECT("con_ADD_Float", pyon_con_ADD_Float);
  ADD_OBJECT("con_SUB_Float", pyon_con_SUB_Float);
  ...
  ADD_OBJECT("AdditiveClass", pyon_AdditiveClass);
  ADD_OBJECT("VectorClass", pyon_VectorClass);
