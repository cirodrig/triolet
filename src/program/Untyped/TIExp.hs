...
unknownRepr :: TIRepr
unknownRepr = internalError "Unknown TIRepr"
...
data TIExp =
    ...
    VarTE !TIInfo !SF.Var
  | LitTE !TIInfo !SF.Lit
  | ConTE !TIInfo !TIConInst [TIExp] [TIExp]
  | AppTE !TIInfo TIExp [TIType] [TIExp]
  | LamTE !TIInfo TIFun
  | LetTE !TIInfo TIPat TIExp TIExp
  | LetfunTE !TIInfo (DefGroup TIDef) TIExp
  | CaseTE !TIInfo TIExp [TIRepr] [TIAlt]
