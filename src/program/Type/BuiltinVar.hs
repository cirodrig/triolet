...
$(let concat_decs d1 d2 = liftM2 (++) d1 d2
      ...
      variables =
        ...
        , ("valInfo_int64", "reprVal_int64", ObjectLevel, True)
        ...
        , ("putStoredByte", "putStoredByte", ObjectLevel, True)
        , ("putStoredInt64", "putStoredInt64", ObjectLevel, True)
        , ("putStoredCursor", "putStoredCursor", ObjectLevel, True)
        ...
        , ("getStoredByte", "getStoredByte", ObjectLevel, True)
        , ("getStoredInt64", "getStoredInt64", ObjectLevel, True)
        , ("getStoredCursor", "getStoredCursor", ObjectLevel, True)
