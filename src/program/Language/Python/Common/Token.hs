...
data Token 
   ...
   | LetToken { token_span :: !SrcSpan }                          -- ^ Keyword: \'let\'. (An extension, not in Python)
   ...
   | RequireToken { token_span :: !SrcSpan }                       -- ^ Keyword: \'require\'.
   | ImportToken { token_span :: !SrcSpan }                       -- ^ Keyword: \'import\'.
   | ExportToken { token_span :: !SrcSpan }                       -- ^ Keyword: \'export\'.
