...
pyonBuiltinVariableNames =
  ...
  , "intSumScatterReduction_updater"
  , "intSumScatterReduction_make_update"
  , "intSumScatterReduction_make_init"
  , "floatSumScatterReduction"
  , "floatSumScatterReduction_updater"
  , "floatSumScatterReduction_make_update"
  , "floatSumScatterReduction_make_init"
  , "countingScatterReduction"
  , "countingScatterReduction_updater"
  , "countingScatterReduction_make_update"
  , "countingScatterReduction_make_init"
  , "comapScatterReductionIndex"
  , "arrScatterReduction"
  , "array1ScatterReduction"
  , "array2ScatterReduction"
