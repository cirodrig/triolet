...
build : $(PYON_TARGET) $(RTS_TARGET) $(PYON_GENERATED_SCRIPTS)
...
# Compile a Pyon source file, found in any of the source paths.
# Parameters:
...
$(BUILDDIR)/pyon/$(1:.hs=.o) : $(1)
	mkdir -p $(BUILDDIR)/pyon/$(dir $(1))
	$(HC) -c $$< $(2)
	touch $(BUILDDIR)/pyon/$(patsubst %.hs,%.hi,$(1))

endef

# Compile a Haskell boot file
define COMPILE_HS_BOOT_SOURCE
$(BUILDDIR)/pyon/$(1:.hs-boot=.o-boot) :
	mkdir -p $(BUILDDIR)/pyon/$(dir $(1))
